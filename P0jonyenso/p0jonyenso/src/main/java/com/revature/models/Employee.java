...
public class Employee {
    ...
    public Employee(int employee_id, String first_name, String last_name, String email, Role role) {
    ...
    public Employee(String first_name, String last_name, String email, Role role) {
        this.first_name = first_name;
        this.last_name = last_name;
        this.email = email;
        this.role = role;
    ...
    public Employee(String first_name, String last_name, String email, int role_id_fk) {
        this.first_name = first_name;
        this.last_name = last_name;
        this.email = email;
